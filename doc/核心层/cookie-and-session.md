...
sessionStore 的实现我们也可以封装到插件中，例如 [cmos-session-redis] 就提供了将 Session 存储到 redis 中的能力，在应用层，我们只需要引入 [cmos-redis] 和 [cmos-session-redis] 插件即可。
